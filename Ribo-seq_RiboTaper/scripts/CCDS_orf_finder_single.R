...
print(j)
                CCDS_orfs <- rbind(CCDS_orfs, transcr_all_frames_ok)
        }
        if(dim(transcr_all_frames_ok)[1]==0){
print("0 check")
CCDS_orfs <- rbind(CCDS_orfs, transcr_all_frames_res)
}
        
        
}
CCDS_orfs_found<-CCDS_orfs[!is.na(CCDS_orfs[,"ORF_pept"]),]
print(head(CCDS_orfs_found))
