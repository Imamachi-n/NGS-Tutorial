...
#coverageBed -s -d -split -abam RIBO_best.bam -b $1 | awk '{ print $1 ";" $2 ";" $3 ";" $4 ";" $5";" $6 "\t" "_" $8}' > data_tracks/RIBO_tracks"_$3"_tmp1
#python3 fastCoverage.py data_tracks/RIBO_tracks"_$3"_tmp1 data_tracks/RIBO_tracks"_$3"_tmp2
#cat data_tracks/RIBO_tracks"_$3"_tmp2 | sed 's/_//g' | sed 's/;/\t/g' | sort -k1,1 -k4,4 -k2,2g > data_tracks/RIBO_tracks"_$3"
#rm data_tracks/RIBO_tracks"_$3"_tmp1
#rm data_tracks/RIBO_tracks"_$3"_tmp2
...
#coverageBed -s -d -split -abam RNA_best.bam -b $1 | awk '{ print $1 ";" $2 ";" $3 ";" $4 ";" $5";" $6 "\t" "_" $8}' > data_tracks/RNA_tracks"_$3"_tmp1
#python3 fastCoverage.py data_tracks/RNA_tracks"_$3"_tmp1 data_tracks/RNA_tracks"_$3"_tmp2
#cat data_tracks/RNA_tracks"_$3"_tmp2 | sed 's/_//g' | sed 's/;/\t/g' | sort -k1,1 -k4,4 -k2,2g > data_tracks/RNA_tracks"_$3"
#rm data_tracks/RNA_tracks"_$3"_tmp1
#rm data_tracks/RNA_tracks"_$3"_tmp2
